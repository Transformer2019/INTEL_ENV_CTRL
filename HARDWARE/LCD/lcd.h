...
//#define LCD_RS_CLR GPIO_ResetBits(GPIOB,GPIO_Pin_3)//DC
...
//#define LCD_CS_CLR  PBout(12) = 0//CS
//#define LCD_CS_SET  PBout(12) = 1


#define LCD_RST_CLR GPIOB->BRR=1<<4//RES
#define LCD_RST_SET GPIOB->BSRR=1<<4

#define LCD_RS_CLR GPIOB->BRR=1<<3//DC
#define LCD_RS_SET GPIOB->BSRR=1<<3

#define LCD_CS_CLR  GPIOB->BRR=1<<12//CS
#define LCD_CS_SET  GPIOB->BSRR=1<<12


////GPIO置位（拉高）
//#define	LCD_CS_SET  GPIO_TYPE->BSRR=1<<LCD_CS    //片选端口  	PB11  12
//#define	LCD_RS_SET	GPIO_TYPE->BSRR=1<<LCD_RS    //数据/命令  PB10	  6
//#define	LCD_RST_SET	GPIO_TYPE->BSRR=1<<LCD_RST   //复位			  PB12 7
